...
export default function HeroMobileNeatBackground() {
  ...
  useEffect(() => {
    ...
    const config = {
      ...
      resolution: 1.15,
      yOffset: baseYOffset,
      yOffsetWaveMultiplier: 5.2,
      yOffsetColorMultiplier: 5.4,
      yOffsetFlowMultiplier: 5.6,
      flowDistortionA: 0.4,
      flowDistortionB: 10,
      flowScale: 3.3,
      flowEase: 0.37,
    ...
    const handleScroll = () => {
      gradient.yOffset = baseYOffset + window.scrollY
    }
  ...
  return (
    <canvas
      ref={canvasRef}
      aria-hidden="true"
      className="pointer-events-none absolute -inset-y-[18%] -left-[58vw] h-[136%] w-[216vw] max-w-none opacity-95"
    />
  )
}
